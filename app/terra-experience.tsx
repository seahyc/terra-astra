...
export default function TerraExperience(){
 ...
 return <main className={`experience stage-${stage}${selected?' has-story':''}${exploring?' is-exploring':''}${options.motion?'':' motion-paused'}`}>
  ...
  <footer className="credits"><span>Geography: Natural Earth <span className="credit-dot">·</span> Night lights: NASA, 2016</span><a href="https://www.openstreetmap.org/copyright" target="_blank" rel="noreferrer">© OpenStreetMap contributors</a></footer>
