...
export const sceneInventory = Object.freeze({
  ...
  detailed_city_targets: ['Singapore', 'New York', 'Palm Jumeirah', 'Makkah'],
  perspectives: ['aerial', 'horizon', 'cutaway'],
  layers: ['satellites', 'aircraft', 'ships', 'urban'],
  orbit: '72 orbital objects',
  aircraft: '120 aircraft on 40 city-pair corridors',
  ships: '24 ships on 12 open-water corridors',
  urban: 'City activity in New York, Singapore, Palm Jumeirah and Makkah',
